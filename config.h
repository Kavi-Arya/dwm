...
/* key definitions */
#define MODKEYALT Mod4Mask // ALT key
...
// static const char *lf[]  = { TERMINAL, "-e", "lfub", NULL };
...
static Keychord keychords[] = {
  ...
  {1, {{ MODKEYALT,                    XK_F12}},    spawn, SHCMD("fuckme") },
	// focusstack :
